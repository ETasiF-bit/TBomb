#!/bin/bash
clear
echo -e "\e[4;31m ET Asif !!! \e[0m"
echo -e "\e[1;34m Presents \e[0m"
echo -e "\e[1;32m ETBomb \e[0m"
...
echo This Script Was Made By SpeedX just edited lol🤫 >update.speedx
...
toilet -f mono12 -F border ETasiF
echo -e "\e[4;34m This Bomber Was edited by ETasiF \e[0m"
echo -e "\e[1;34m For Any Queries Mail Me!!!\e[0m"
echo -e "\e[1;32m WhatsAMlsya@gmail.com \e[0m"
echo -e "\e[4;32m   0 \e[0m"
echo " "
...
clear
echo -e "\e[1;32m"
echo 'Call Bomb By ETasiF'> call.xxx
...
git clone https://github.com/ETasif-bit/ETbomb
if [[ -s ETBomb/TBomb.sh ]];then
cd TBomb
cp -r -f * .. > temp
cd ..
rm -rf  ETBomb >> temp
...
echo -e "\e[1;32m ETBomb Will Restart Now..."
...
echo -e "\e[1;33m"
figlet TBomb
echo -e "\e[1;34mEdited By \e[1;34m"
toilet -f mono12 -F border ETasiF
echo  " "
